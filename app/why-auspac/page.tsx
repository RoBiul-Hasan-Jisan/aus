  ...
  return (
    <div className="w-full bg-white text-slate-900 pb-16">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 sm:mt-12">
        ...
        {/* Core Value Proposition - Two Column Layout */}
        <section className="mb-16 border-t-2 border-slate-900 pt-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            
            {/* Left Column: The "Why" Context */}
            <div className="lg:col-span-5">
              <h2 className="text-xs font-bold tracking-[0.2em] uppercase text-slate-500 mb-8">
                Strategic Advantage
              </h2>
              <div className="space-y-6 text-lg text-slate-600 font-light leading-relaxed pr-0 lg:pr-8">
                <p>
                ...
                <p className="text-xl font-medium text-slate-900 mt-8 pt-8 border-t border-slate-200">
            ...
            {/* Right Column: The 5 Differentiators */}
            <div className="lg:col-span-7">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10">
                {differentiators.map((item, index) => (
                  <div key={index} className="relative group">
                    <div className="text-3xl font-light text-slate-200 mb-3 transition-colors duration-300 group-hover:text-blue-800">
                      {item.number}
                    </div>
                    <h3 className="text-sm font-bold uppercase tracking-wider text-slate-900 mb-2 border-b border-slate-200 pb-3">
                      {item.title}
                    </h3>
        ...
        {/* Slim CTA Banner */}
         <section className="bg-blue-900 text bg-slate-500 flex flex-col md:flex-row items-center justify-between p-8 sm:p-12 rounded-lg">
          ...
          <Link
            href="/contact"
            className="shrink-0 bg-blue-600 hover:bg-blue-500 text-white px-8 py-3 text-sm font-bold tracking-widest uppercase transition-colors"
          >
            Engage AusPac
          </Link>
        </section>
